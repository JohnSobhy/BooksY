                    ...
                    item {
                        AndroidView(
                            ...
                            update = { view ->
                                ...
                                textView.highlights = savedHighlightBuilder.value.build()
                                ...
                                textView.customSelectionActionModeCallback =
                                    object : ActionMode.Callback {
                                        override fun onCreateActionMode(
                                            ...
                                            val isHighlighted = bookHighlights.any { highlight ->
                                            ...
                                            when (item.itemId) {
                                                R.id.action_highlight -> {
                                                    ...
                                                    if (start != end) {
                                                        ...
                                                        val highLightBuilder = Highlights.Builder()
                                                            .addRange(yellowPaint, start, end)
                                                        val highlights = highLightBuilder.build()
                                                        Log.d(
                                                            "BookContentScreen",
